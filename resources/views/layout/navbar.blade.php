...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark " style="background-color: rgb(25, 61, 179)">
...
<ul class="navbar-nav mx-auto mb-2 mb-lg-0">
    ...
    <li class="nav-item">
        <a class="nav-link active" href="/data_petugas" tabindex="-1" aria-disabled="true"><b>Data Petugas</b></a>
    </li>
    <li class="nav-item">
        <a class="nav-link active" href="/data_masyarakat" tabindex="-1" aria-disabled="true"><b>Data Masyarakat</b></a>
    </li>
    <li class="nav-item">
