    ...
    <div class="grid container mb-5 register">
      ...
      <form method="POST" action="" class="container mt-5" style="box-size:50%; background-color: rgba(238, 234, 234, 0.8);border-radius:5px;box-shadow: 5px 5px #BAD7E9;">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="nama" id="exampleInputPassword1" maxlength="35" @required(true)>
        </div>
        <div class="mb-3">
          <label for="exampleInputPassword1" class="form-label">Username</label>
          <input type="text" class="form-control" name="username" id="exampleInputPassword1" maxlength="25" @required(true)>
        </div>
        <div class="mb-3">
          <label for="exampleInputPassword1" class="form-label">Password</label>
          <input type="password" class="form-control" name="password" id="exampleInputall1" maxlength="32" @required(true)>
        </div>
        <div class="mb-3">
          <label for="exampleInputPassword1" class="form-label">Telepon</label>
          <input type="text" class="form-control" name="telp" id="exampleInputPassword1" maxlength="13" @required(true)>
        </div>
